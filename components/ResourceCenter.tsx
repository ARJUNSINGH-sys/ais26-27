...
const concepts: Concept[] = [
  {
    ...
    summary:
      "The computational core of modern Large Language Models calculating contextual token relevance.",
  ...
  },
  {
    ...
    summary:
      "Sliding localized filter kernels across pixel matrices to extract hierarchical edge and texture features.",
  ...
  },
  {
    ...
    summary:
      "Iterative parameter optimization traversing multi-dimensional loss surfaces toward global minima.",
  ...
  },
  {
    ...
    summary:
      "Progressive Markovian transition reversing Gaussian noise to reconstruct high-fidelity latent tensors.",
  ...
  },
  {
    ...
    category: "TRANSFORMERS",
    summary:
      "Controlling prediction entropy: low temperature forces greedy argmax; high temperature enables creativity.",
...
export default function ResourceCenter() {
  ...
  return (
    <section
      id="resources"
      className="py-24 md:py-32 bg-[#F7F7F5] border-t border-[#E2E2DE]"
    >
      <div className="bw-container">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6 mb-12 md:mb-16">
          ...
          <p className="text-[14px] sm:text-[15px] text-[#666663] max-w-[38ch] lg:text-right">
            Interactive mathematical and intuitive visualizers for foundational
            machine learning and deep neural architectures.
          </p>
        </div>
              ...
              <div className="lg:col-span-5 flex flex-col gap-6">
                <div>
                  ...
                  <p className="text-[13px] text-[#666663] mb-4">
                    Click a word to inspect how its Query vector attends to all
                    Key vectors across the sequence:
                  </p>
                ...
                <div className="bg-[#F7F7F5] p-5 rounded-[24px] border border-[#E2E2DE]">
                  ...
                  <p className="text-[12px] text-[#666663] mt-2">
                    Higher percentages denote stronger bidirectional contextual
                    affinity within multi-head attention blocks.
                  </p>
                </div>
              </div>
                      ...
                      <div key={targetToken} className="space-y-1.5">
                        <div className="flex justify-between text-[13px] font-mono">
                          <span className="text-white/90 flex items-center gap-2">
                            ...
                            {selectedTokenIdx === idx && (
                              <span className="text-[10px] text-[#A1A19D]">
                                (self)
                              </span>
                            )}
                          </span>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              <div className="lg:col-span-5 space-y-6">
                <div>
                  ...
                  <p className="text-[13px] text-[#666663] mb-4">
                    Choose an analytical 3×3 matrix convolution kernel to
                    observe edge gradient response:
                  </p>
                  <div className="flex flex-wrap gap-2">
                    <button
                      type="button"
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-6 py-4">
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    <div className="grid grid-cols-4 gap-1.5 p-3 bg-white/5 rounded-[18px] border border-white/10">
                      {[
                        120, 130, 240, 255, 115, 125, 235, 250, 110, 120, 230,
                        245, 105, 115, 225, 240,
                      ].map((px, idx) => (
                        <div
                          key={idx}
                          ...
                          style={{
                            backgroundColor: `rgba(255, 255, 255, ${px / 320})`,
                          }}
                        >
                          {px}
                        </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              <div className="lg:col-span-5 space-y-6">
                ...
                <div className="p-5 bg-[#F7F7F5] rounded-[24px] border border-[#E2E2DE] text-[13px] text-[#666663] leading-relaxed">
                  ...
                  Parameter updates follow the negative gradient vector pointing
                  ...
                  >
                    ...
                    {(() => {
                      const steps = [
                        ...
                        {
                          x: 200 + 40 * learningRate,
                          y: 100 + 10 * learningRate,
                        },
                        {
                          x: 235 + 15 * learningRate,
                          y: 108 + 2 * learningRate,
                        },
                        { x: 250, y: 110 },
                      ];
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              <div className="lg:col-span-5 space-y-6">
                ...
                <div className="p-5 bg-[#F7F7F5] rounded-[24px] border border-[#E2E2DE] text-[13px] text-[#666663]">
                  <span className="font-bold text-[#0A0A0A] block mb-1">
                    Noise Level: {Math.round((timestep / 1000) * 100)}% Gaussian
                    Perturbation
                  </span>
                  Neural U-Net predicts the score function ∇_x log p_t(x) at
                  each discrete transition step.
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              <div className="lg:col-span-5 space-y-6">
                ...
                <div className="p-5 bg-[#F7F7F5] rounded-[24px] border border-[#E2E2DE] text-[13px] text-[#666663]">
                  ...
                  Divides logit scores prior to exponentiation to sharpen or
                  flatten the probability simplex.
                </div>
              </div>
